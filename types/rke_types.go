...
type IngressConfig struct {
	...
	NginxIngressControllerPriorityClassName string `yaml:"nginx_ingress_controller_priority_class_name,omitepmty" json:"nginxIngressControllerPriorityClassName,omitempty"`
	// Enable or disable nginx default-http-backend
	DefaultIngressClass *bool `yaml:"default_ingress_class,omitempty" json:"defaultIngressClass,omitempty" norman:"default=true"`
}
...
type MonitoringConfig struct {
	...
	Replicas *int32 `yaml:"replicas,omitempty" json:"replicas,omitempty" norman:"default=1"`
	// Tolerations for Deployments
	Tolerations []v1.Toleration `yaml:"tolerations,omitempty" json:"tolerations,omitempty"`
...
type LinearAutoscalerParams struct {
	...
	Min                       int     `yaml:"min,omitempty" json:"min,omitempty" norman:"default=1"`
...
type ECRCredentialPlugin struct {
	AwsAccessKeyID     string `yaml:"aws_access_key_id,omitempty" json:"awsAccessKeyId,omitempty"`
	AwsSecretAccessKey string `yaml:"aws_secret_access_key,omitempty" json:"awsSecretAccessKey,omitempty"`
	AwsSessionToken    string `yaml:"aws_session_token,omitempty" json:"awsAccessToken,omitempty"`
}
